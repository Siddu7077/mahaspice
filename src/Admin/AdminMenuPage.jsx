...
const AdminMenuPage = () => {
    ...
    const fetchCategories = async () => {
        try {
            const response = await fetch('https://orchid-grasshopper-305065.hostingersite.com/getgscd.php');
    ...
    const getImageUrl = (imageUrl) => {
        if (imageUrl && !imageUrl.startsWith('http')) {
            return `https://orchid-grasshopper-305065.hostingersite.com/${imageUrl}`;
        }
        return imageUrl;
    };
    ...
    const deleteCategory = async (categoryId) => {
        try {
            const response = await fetch(`'https://orchid-grasshopper-305065.hostingersite.com//deletegscd.php?id=${categoryId}`, {
                method: "POST",
            });
