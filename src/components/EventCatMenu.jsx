...
const EventCatMenu = () => {
  ...
  const filteredMenuItems = selectedCategory
    ? menuCategories[selectedCategory].filter(
        (item) => foodFilter === "all" || item.type === foodFilter
      )
    : [];
              ...
              <div className="grid grid-cols-2 gap-4">
                {filteredMenuItems.map((item) => (
                  <div key={item.name} className="p-4 bg-gray-50 rounded-lg">
                    {/* Wrap the entire item div with the label */}
                    <label
                      htmlFor={item.name}
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        ...
                        onChange={() =>
                          handleItemSelect(selectedCategory, item.name)
                        }
                      ...
                      <span
                          className={`w-6 h-6 p-1 mr-2 border-2 ${
                            item.type === "veg"
                              ? "border-green-500"
                              : "border-red-500"
